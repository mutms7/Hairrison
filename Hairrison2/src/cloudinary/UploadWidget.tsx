  ...
  return (
    <button
      ...
      style={{
        ...
        backgroundColor: isReady ? 'var(--color-accent, #c8112b)' : 'var(--color-surface-3, #202020)',
        border: isReady ? 'none' : '1px solid var(--color-border, #272727)',
        borderRadius: 0,
      ...
      onMouseEnter={(e) => {
        if (isReady) e.currentTarget.style.backgroundColor = 'var(--color-accent-hover, #e01530)';
      }}
      onMouseLeave={(e) => {
        if (isReady) e.currentTarget.style.backgroundColor = 'var(--color-accent, #c8112b)';
      }}
    >
